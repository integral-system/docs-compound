...
{
	return (Run("Page ") + Run(" " + extras.Index + " ") * { Color = "FFFFFF00", TypoframeColor = "5A31A500"} + extras.Separator) * params.format;
}
...
function CMyDocument::Sequence_Footer(title, params, extras)
{
	...
	return (Run(title_a) * {Color = "FFFFFF00", TypoframeColor = "5A31A500"} + title_b) * params.format;
}
