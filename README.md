...
* **Complex Publication** ([journal-neural/doc.i](journal-neural/doc.i)): A complex publication consisting of 20 pages and 4 articles that showcases INTEGRAL's [incremental build system](#incremental-build-system).
